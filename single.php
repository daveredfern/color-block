...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	...
	?>
		<?php if( get_row_layout() == 'portfolio_block_text' ): ?>
			<div class="u-clearfix<?php if(get_sub_field('remove_margin')[0] != 'yes') : ?> u-section<?php endif; ?> portfolio-box" style="background-color: <?php the_sub_field('portfolio_background_color'); ?>">
